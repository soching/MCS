...
using Task = create_test.Models.Task;

namespace create_test.Data
{
    public partial class create_testContext : DbContext
    {
        public create_testContext()
        {
        }

        public create_testContext(DbContextOptions<create_testContext> options)
            : base(options)
        {
        }
